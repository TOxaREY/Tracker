...
final class CreationIrregularEventViewController: UIViewController {
    ...
    private func makeConstraints() {
        containerHeightAnchorConstraint = container?.heightAnchor.constraint(equalToConstant: 706)
    ...
    private func checkAllFillField() {
        if creationEvent.name != "" && creationEvent.category != "" && creationEvent.emoji != "" && creationEvent.color != nil && !isLimitSimbol {
    ...
    private func addTracker() {
        ...
        for category in oldCategories {
            if category.title == creationEvent.category {
                ...
                newTrackers.append(Tracker(id: UUID().uuidString, name: creationEvent.name, color: creationEvent.color!, emoji: creationEvent.emoji, shedule: creationEvent.sheduleIrregullarEvent))
        ...
        if !newCategories.contains(where: { $0.title == creationEvent.category }) {
            newCategories.append(TrackerCategory(title: creationEvent.category, trackers: [Tracker(id: UUID().uuidString, name: creationEvent.name, color: creationEvent.color!, emoji: creationEvent.emoji, shedule: creationEvent.sheduleIrregullarEvent)]))
        }
...
extension CreationIrregularEventViewController: UITableViewDelegate {
...
extension CreationIrregularEventViewController: DataSourceDelegate {
    func setDataSource() {
...
extension CreationIrregularEventViewController: UICollectionViewDataSource {
...
extension CreationIrregularEventViewController: UICollectionViewDelegateFlowLayout {
...
extension CreationIrregularEventViewController: UICollectionViewDelegate {
...
extension CreationIrregularEventViewController: UITextFieldDelegate {
    ...
    private func setLimitSimbolLabel() {
        if isLimitSimbol {
            ...
            containerHeightAnchorConstraint = container?.heightAnchor.constraint(equalToConstant: 744)
